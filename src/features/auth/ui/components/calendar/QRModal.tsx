...
export function QRModal({ state }: { state: any }) {
  ...
  return (
    <div className="fixed inset-0 z-[280] flex items-center justify-center bg-zinc-900/60 p-4">
      <div className="bg-white rounded-[24px] border border-neutral-200 p-6 max-w-[340px] w-full text-center space-y-4">
