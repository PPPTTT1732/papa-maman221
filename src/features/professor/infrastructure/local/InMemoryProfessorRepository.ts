...
const MOCK_SCHEDULE_T1: ProfessorSchedule[] = [
  { id: 'sch-1', courseId: 'course-1', courseTitle: 'Algorithmique Avancée', day: 'Lundi', time: '08:00 - 11:00', room: 'Amphi A', type: 'CM', dateStr: 'Lundi 06 Juillet 2026' },
  { id: 'sch-2', courseId: 'course-4', courseTitle: "Sécurité des Systèmes d'Information", day: 'Mardi', time: '13:00 - 16:00', room: 'Amphi B', type: 'CM', dateStr: 'Mardi 07 Juillet 2026' },
  { id: 'sch-3', courseId: 'course-1', courseTitle: 'TD Algorithmique Avancée', day: 'Mercredi', time: '10:00 - 12:00', room: 'Labo 5', type: 'TD', dateStr: 'Mercredi 08 Juillet 2026' },
];

const MOCK_SCHEDULE_T2: ProfessorSchedule[] = [
  { id: 'sch-4', courseId: 'course-2', courseTitle: 'Management Stratégique II', day: 'Mardi', time: '09:00 - 12:00', room: 'Salle C', type: 'CM', dateStr: 'Mardi 07 Juillet 2026' },
  { id: 'sch-5', courseId: 'course-5', courseTitle: 'Prise de Parole en Public', day: 'Jeudi', time: '10:00 - 13:00', room: 'Salle Rethorique 1', type: 'CM', dateStr: 'Jeudi 09 Juillet 2026' },
];
