...
export function CameraScanner({ cameraStream, videoRef, onCancel }: CameraScannerProps) {
  return (
    <div className="p-6 text-center space-y-4">
      <p className="text-xs text-secondary leading-relaxed font-semibold">
        Scannage en cours... Orientez l'appareil vers le code QR de l'amphithéâtre.
      </p>
