...
export function PresenceModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[250] bg-black/55 flex items-center justify-center p-4 backdrop-blur-xs">
      <div className="bg-white w-full max-w-[320px] rounded-2xl overflow-hidden shadow-2xl border border-neutral-100/50 animate-in fade-in zoom-in-95 duration-200">
