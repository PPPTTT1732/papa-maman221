  ...
  return (
    ...
    >
      <div className="mb-6 px-4 flex flex-col items-start">
        <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#B3181C] to-[#6B0E10] text-white flex items-center justify-center font-black shadow-md shadow-[#B3181C]/25 transition-transform duration-300 hover:scale-105 active:scale-95 cursor-pointer" onClick={() => navigate(ROUTES.student.dashboard)}>
