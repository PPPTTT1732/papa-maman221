...
export function CourseDetailModal({ state }: { state: any }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl border border-neutral-gray-200/60 flex flex-col transform transition-all duration-300 scale-100">
